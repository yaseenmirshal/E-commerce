...
function Navbar() {
  ...
  return (
    ...
    <MDBCard className='card1'>
      <MDBCardImage src='https://joneswardrobes.com/wp-content/uploads/2024/01/Corner-Wardrobe-Home-Desk-Dressing-Table-Modern-and-Minimalist-Combination-Top-To-Top-Wardrobe-Economy-Wardrobe-1.jpg.webp' position='top' alt='...' />
      <MDBCardBody>
